...
// Source: globalping/globalping.go
...
func (m *MockClient) GetRawMeasurement(id string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetRawMeasurement(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRawMeasurement", reflect.TypeOf((*MockClient)(nil).GetRawMeasurement), id)
}
