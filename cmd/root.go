...
func init() {
	...
	rootCmd.PersistentFlags().BoolVar(&ctx.Share, "share", false, "Prints a link at the end the results, allowing to vizualize the results on the Globalping website (default false)")
}
